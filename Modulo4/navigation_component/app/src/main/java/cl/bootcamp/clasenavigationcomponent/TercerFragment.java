package cl.bootcamp.clasenavigationcomponent;
...
import cl.bootcamp.clasenavigationcomponent.databinding.FragmentTercerBinding;
    ...
    public void onViewCreated(@NonNull View view, @Nullable Bundle savedInstanceState) {
        ...
        binding.btnVolver.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Navigation.findNavController(view).navigate(R.id.action_tercerFragment_to_secondFragment);
            }
        });
        ...
        binding.btnHome.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Navigation.findNavController(view).navigate(R.id.action_tercerFragment_to_defaultFragment);
            }
        });
    }
}