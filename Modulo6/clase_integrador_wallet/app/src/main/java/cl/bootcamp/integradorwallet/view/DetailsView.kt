...
import cl.bootcamp.integradorwallet.components.TopBarComponent
import cl.bootcamp.integradorwallet.viewModel.WalletViewModel
import coil.compose.rememberAsyncImagePainter

@Composable
fun DetailsView(viewModel: WalletViewModel, navController: NavController, id: Int) {
...
@Composable
fun ContentDetailView(paddingValues: PaddingValues, viewModel: WalletViewModel) {
    ...
    var mensaje = """Hola
        ...
        Somos el equipo de Wallet, necesitamos contactarte contigo,
        para recibir más información importante.
    ...
    Column(
        ...
        Column(
            ...
            Column(
                ...
                Text(text = "Pais: ${state.pais}", fontWeight = FontWeight.Bold)
                HorizontalDivider()
